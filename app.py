...
if choose == "About":
    ...
    with col1:  # To display the header text using css style
        ...
        st.markdown(
            "In this application we are using OpenCV and face_recognition module for creating a **Face Recognition Application** . **Streamlit** is to create the Web Graphical User Interface (GUI). "
        )
    st.markdown(
        """
    <style>
    ...
    with col1:  # To display the header text using css style
        ...
        st.markdown(
            '<p class="font">Face Recognition App...</p>', unsafe_allow_html=True
        )
